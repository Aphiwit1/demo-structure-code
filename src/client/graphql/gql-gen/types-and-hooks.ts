...
export const FilmItemFragmentDoc = `
  ...
  producers
    ...
    `;
export const NuengQueryDocument = `
    query nuengQuery {
  allFilms {
    films {
      title
...
export const useNuengQueryQuery = <
      TData = NuengQueryQuery,
      TError = unknown
    >(
...
useNuengQueryQuery.fetcher = (client: GraphQLClient, variables?: NuengQueryQueryVariables, headers?: RequestInit['headers']) => fetcher<NuengQueryQuery, NuengQueryQueryVariables>(client, NuengQueryDocument, variables, headers);
